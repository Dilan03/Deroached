...
if(state == "going back" || state = "check out" || state == "checking out" || state == "nothing here") {
...
if(image_angle_ >= 316 && image_angle_ <= 45) {
	image_index = 0;
} else if (image_angle_ >= 46 && image_angle_ <= 135) {
	image_index = 1
} else if (image_angle_ >= 136 && image_angle_ <= 225) {
	image_index = 2
} else if (image_angle_ >= 226 && image_angle_ <= 315) {
	image_index = 3
}
